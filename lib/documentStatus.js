...
module.exports = class documentStatus {
  ...
  /**
   * Write link to badge with url
   * 
   * @memberof documentStatus#imagelink
   * @param {String, String, String} - Badge Name, url to badge image, link
   */
  imagelink(title, url) {
    return `[![${title}](./assets/${title.replace(/[\/\\ ]/gm, '-')}.svg)](${url})`;
  }
